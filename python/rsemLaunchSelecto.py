...
os.chdir('/mnt/parallel_scratch_mp2_wipe_on_august_2017/dubemar1/augerjer/MicrobiomeData/NCBI-Taxonomy/rsemSelectShellCmd')
cmd = 'rm /mnt/parallel_scratch_mp2_wipe_on_august_2017/dubemar1/augerjer/MicrobiomeData/NCBI-Taxonomy/rsemSelectShellCmd/*'
os.system(cmd)
...
for r1Handle in r1List:
    ...
    with open("{0}CalcExpr.sh".format(samNum), "a") as myfile:
        ...
        myfile.write("cd /mnt/parallel_scratch_mp2_wipe_on_august_2017/dubemar1/augerjer/MicrobiomeData/NCBI-Taxonomy/rsemSelectOut \n\n")
